...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url()?>" class="logo">
			...
			<span class="logo-lg"><b>GIS Photo Studio</span>
		</a>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo base_url('assets/adminlte/dist/img/hann.png')?>" class="user-image" alt="User Image">
	...
	<footer class="main-footer">
		<strong>Copyright &copy; Hanantri Puspita Dewi</strong> All rights
		reserved.
	</footer>
